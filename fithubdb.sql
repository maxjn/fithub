...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2023 at 07:34 PM
...
(5, 4, 'تی آر ایکس', 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فسارا تکنولوژی مورد نیاز، و .', 'class-img5.jpg', '1 ماه', 12, 'روز های زوج', '8:00 - 9:00 ق.ظ', 30, 600),
