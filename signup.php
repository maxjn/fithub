                ...
                <div class="appointment-bg wow fadeInLeft" data-wow-delay=".5s"
                    ...
                    <form method="post" action="action-signup.php">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-box">
                                    <input type="text" name="Name" class="form-input" placeholder="نام نام خانوادگی"
                                        required="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-box">
                                    <input type="email" name="Email" class="form-input" placeholder="آدرس ایمیل"
                                        required="">
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-box">
                                    <input type="password" name="RepeatPassword" class="form-input"
